...
-- Started on 2016-03-23 17:05:16
...
CREATE TABLE studente (
    ...
    cittadinanza text,
    codice_fiscale text,
    voto_scuola_media_superiore numeric,
...
--
-- TOC entry 2030 (class 2604 OID 24683)
...
--
-- TOC entry 2033 (class 2604 OID 24717)
...
--
-- TOC entry 2031 (class 2604 OID 24694)
...
--
-- TOC entry 2029 (class 2604 OID 24672)
...
--
-- TOC entry 2034 (class 2604 OID 24728)
...
--
-- TOC entry 2032 (class 2604 OID 24705)
...
--
-- TOC entry 2036 (class 2606 OID 24805)
...
--
-- TOC entry 2038 (class 2606 OID 24807)
...
--
-- TOC entry 2040 (class 2606 OID 24811)
-- Name: lauree_fact_pkey; Type: CONSTRAINT; Schema: AVA; Owner: postgres
--

ALTER TABLE ONLY lauree_fact
    ADD CONSTRAINT lauree_fact_pkey PRIMARY KEY (k_studente, k_anno_accademico, k_corso_di_studi, k_tempo);
...
--
-- TOC entry 2064 (class 2606 OID 24789)
...
--
-- TOC entry 2065 (class 2606 OID 24794)
...
-- Name: lauree_fact_k_studente_fkey; Type: FK CONSTRAINT; Schema: AVA; Owner: postgres
--

ALTER TABLE ONLY lauree_fact
    ADD CONSTRAINT lauree_fact_k_studente_fkey FOREIGN KEY (k_studente) REFERENCES studente(k_studente);


--
-- TOC entry 2066 (class 2606 OID 24799)
...
-- Completed on 2016-03-23 17:05:17
